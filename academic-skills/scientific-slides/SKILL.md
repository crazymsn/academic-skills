...
3. **Default author is "Academic Skills"** unless another name is specified
...
python scripts/generate_slide_image.py "Title slide for presentation: 'Machine Learning: From Theory to Practice'. Subtitle: 'AI Conference 2025'. Speaker: Academic Skills. FORMATTING GOAL: Dark blue background (#1a237e), white text, gold accents (#ffc107), minimal design, sans-serif fonts, generous margins, no decorative elements." -o slides/01_title.png
...
See `academic-skills/pptx/SKILL.md` for complete PPTX creation documentation.
...
**Reference**: See `academic-skills/pptx/SKILL.md` for complete documentation
...
python academic-skills/pptx/scripts/thumbnail.py presentation.pptx review/thumb
```
...
2. Read `academic-skills/pptx/SKILL.md`
...
python academic-skills/pptx/scripts/thumbnail.py presentation.pptx review/grid
```
...
From `academic-skills/pptx/scripts/`:
...
2. **Generate Slides with Nano Banana Pro** (1-2 hours):
   ...
   **Important: Use consistent formatting, attach previous slides, and include citations!**
   ...
   ```bash
   # Title slide (establishes style - default author: Academic Skills)
   python scripts/generate_slide_image.py "Title slide: 'Your Research Title'. Conference name, Academic Skills. FORMATTING GOAL: [your color scheme], minimal professional design, no decorative elements, clean and corporate." -o slides/01_title.png
...
See `academic-skills/pptx/SKILL.md` for complete PowerPoint workflow.
