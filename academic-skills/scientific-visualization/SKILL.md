...
- `academic-skills/seaborn/SKILL.md` - Comprehensive seaborn documentation
- `academic-skills/seaborn/references/examples.md` - Practical use cases
- `academic-skills/seaborn/references/function_reference.md` - Complete API reference
- `academic-skills/seaborn/references/objects_interface.md` - Modern declarative API
